...
//Pályaelemet reprezentáló osztály.
public class LevelPart {
	//pályán belüli hely (x,y)
	private int x;
	private int y;
	//pályaelemben szerplõ blokkok
	private Block[] blocks;
	//szomszédos pályaelemek tárolása
	private HashMap<Direction, LevelPart> neighbours;
	//különbözõ irányokba való pályaelemek közti átjárhatóság tárolása
	...
	//Újraszámolja a Neighbours és a Passabilities listákat
	public void update() {
		SkeletonHelper.enterMethod();
		updatePosition();
	...
	//A játékos elhagyhatja-e az elemet az adott irányba
